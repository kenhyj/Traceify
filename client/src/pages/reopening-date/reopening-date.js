        ...
        return (
            <div style={{ textAlign: "center" }}>
                ...
                <Table id='provtable'>
                    <TableHead>
                        <TableRow>
                            <TableCell style={{ width: "50%", textAlign: "center"}}>Service</TableCell>
        ...
        for (const x of mesage) {
            return (
                <TableRow>
                    ...
                    <TableCell style={{ textAlign: "center"}}>{breaklines(mesage[1])}</TableCell>
                </TableRow>
            );
        }
    });
...
function Reopen() {
    ...
    return (
        ...
        >
            ...
            <br/><br/>
            <Instruction text="Please select a Province/Territory then a phase/stage." width="30%"/>
