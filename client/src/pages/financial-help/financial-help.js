    ...
    const helpResources = [
        {
            ...
            descriptions: ["The benefit provided by the Canadian Federal Government for those affected by COVID-19."],
        ...
        },
        {
            ...
            descriptions: ["The Canada Emergency Student Benefit (CESB) provides financial support to post-secondary students, and recent post-secondary and high school graduates who are unable to find work due to COVID-19."],
