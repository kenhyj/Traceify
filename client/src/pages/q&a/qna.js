...
const QnA = () => {
    ...
    return (
        ...
        >
                ...
                <div className={classes.root}>
                    <Accordion>
                        <AccordionSummary
                            ...
                            id="panel1a-header"
                        >
                            <Typography className={classes.heading}>What is this website for?</Typography>
                        </AccordionSummary>
                        <AccordionDetails style={{padding: '5%'}}>
                            <Typography>
                                This is a contact tracing website for Vancouver built by a group of UBC CS students. Blah Blah Blah
                            </Typography>
                        </AccordionDetails>
                    </Accordion>
                    <Accordion>
                        <AccordionSummary
                            ...
                            id="panel2a-header"
                        >
                            <Typography className={classes.heading}>Description of each page</Typography>
                        </AccordionSummary>
                        <AccordionDetails style={{padding: '5%'}}>
                            <Typography>
                    ...
                    <Accordion>
                        <AccordionSummary
                            ...
                            id="panel3a-header"
                        >
                            <Typography className={classes.heading}>Are all the information up-to-date?</Typography>
                        </AccordionSummary>
                        <AccordionDetails style={{padding: '5%'}}>
                            <Typography>
                                Unfortunately no. Vancouver does not provide any open-source dataset on COVID patients. The data shown on this map is solely deduced from available news articles.
                            </Typography>
                        </AccordionDetails>
                    </Accordion>
                </div>
            ...
            <div className="wrapper">
                <PageHeader text="FINANCIAL HELP"/><br/>
                <br/>
                <div className={classes.root}>
                    <Accordion>
                        <AccordionSummary
                            ...
                            id="panel1a-header"
                        >
                            <Typography className={classes.heading}>Canadian Emergency Response Benefit (CERB)</Typography>
                        </AccordionSummary>
                        <AccordionDetails style={{padding: '5%'}}>
                    ...
                    <Accordion>
                        <AccordionSummary
                            ...
                            id="panel2a-header"
                        >
                            <Typography className={classes.heading}>Canadian Emergency Student Benefit (CESB)</Typography>
                        </AccordionSummary>
                        <AccordionDetails style={{padding: '5%'}}>
                            <Typography className='typography'>
                    ...
                    <Accordion>
                        <AccordionSummary
                            ...
                            id="panel3a-header"
                        >
                            <Typography className={classes.heading}>B.C. Emergency Benefit for Workers</Typography>
                        </AccordionSummary>
                        <AccordionDetails style={{padding: '5%'}}>
                            <Typography className='typography'>
            ...
            <div className="wrapper">
                <PageHeader text="OTHER USEFUL WEBSITES"/><br/>
                <br/>
                <div className={classes.root}>
                    <Accordion>
                        <AccordionSummary
                            ...
                            id="panel1a-header"
                        >
                            <Typography className={classes.heading}>Location of COVID-19 Testing Centres</Typography>
                        </AccordionSummary>
                        <AccordionDetails style={{padding: '5%'}}>
                            <Typography className='typography'>
                    ...
                    <Accordion>
                        <AccordionSummary
                            ...
                            id="panel2a-header"
                        >
                            <Typography className={classes.heading}>Wait Time of Hospitals</Typography>
                        </AccordionSummary>
                        <AccordionDetails style={{padding: '5%'}}>
                            <Typography className='typography'>
                    ...
                    <Accordion>
                        <AccordionSummary
                            ...
                            id="panel3a-header"
                        >
                            <Typography className={classes.heading}>B.C. COVID-19 Dashboard</Typography>
                        </AccordionSummary>
                        <AccordionDetails style={{padding: '5%'}}>
                            <Typography className='typography'>
