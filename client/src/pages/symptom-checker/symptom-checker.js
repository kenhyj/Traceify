...
import { Button, Grid, Checkbox, FormLabel, FormControl, FormGroup, FormControlLabel } from '@material-ui/core';
                ...
                <FormGroup row='true'>
                    {symptomtype.map((somesymptoms) => (
                        <Grid item xs={3}>
                            <FormControlLabel
                                control={
                                    <Checkbox onChange={this.handleChange} name={somesymptoms} color="default"/>
                                }
                                label={somesymptoms}
                            />
                        </Grid>
        ...
        return (
            ...
            >
                ...
                <FormControl onSubmit={this.handleSubmit} className="page-content">
                    <Instruction text="Please check all the boxes below that applies to you:" width="50%"/>
                    {this.typeform(this.props.diagnosis.atrisk.sort())}
                    <br /><br /><br/><br/>
                    <Instruction text="Please check all the boxes below that you've experienced recently
                        eg.last 2-14 days:" width="50%"/>
                    {this.typeform(
